assembler: assembler.o helpFuncs.o firstPass.o secondPass.o opcode.o guidances.o dataCodeImages.o instructions.o symbolTable.o
	gcc -ansi -Wall -pedantic -g helpFuncs.o assembler.o firstPass.o secondPass.o opcode.o guidances.o dataCodeImages.o instructions.o symbolTable.o -o assembler
...
assembler.o: assembler.c globals.h helpFuncs.h firstPass.h secondPass.h opcode.h guidances.h dataCodeImages.h instructions.h symbolTable.h
