assembler: assembler.o helpFuncs.o firstPass.o opcode.o guidances.o dataCodeImages.o instructions.o
	gcc -ansi -Wall -pedantic -g helpFuncs.o assembler.o firstPass.o opcode.o guidances.o dataCodeImages.o instructions.o -o assembler
...
assembler.o: assembler.c globals.h helpFuncs.h firstPass.h opcode.h guidances.h dataCodeImages.h instructions.h
